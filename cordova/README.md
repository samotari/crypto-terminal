...
```bash
cd crypto-terminal/cordova
cordova platform add browser
cordova run browser
```

Open your browser and navigate to [http://localhost:8000/index.html](http://localhost:8000/index.html). You should see the settings screen the first time you open the app.
