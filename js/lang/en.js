...
app.lang['en'] = (function() {
	...
	return {
		...
		'payment-history.export.currency': 'Currency',
		'payment-history.export.amount': 'Amount',
		'payment-history.export.rate': 'Exchange rate',
		'payment-history.export.method': 'Payment method',
		'payment-history.export.status': 'Status',
		'payment-history.export.timestamp': 'Date',
